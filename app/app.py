...
def main() -> None:
    ...
    pages = [
        st.Page("Home.py", title="Nutrition Explorer", icon=":material/restaurant:", default=True),
        ...
        st.Page("Compare.py", title="Compare items", icon=":material/bar_chart:", url_path="compare"),
